...
const en = {
  ...
  quote: {
    ...
    lineItems: [
      {
        description: "Painting living room and hallway (16h)",
        details: "Jan: 10h, Piet: 6h — site: Dorpsstraat 12, Amsterdam",
        quantity: 16,
        unitPrice: 45,
      },
      { description: "Materials: paint and tape", details: "", quantity: 1, unitPrice: 120 },
      { description: "Ladder rental (2 days)", details: "", quantity: 2, unitPrice: 15 },
    ],
    vatMode: "standard",
    vatRate: 21,
...
const nl = {
  ...
  quote: {
    ...
    lineItems: [
      {
        description: "Woonkamer en gang schilderen (16 uur)",
        details: "Jan: 10 uur, Piet: 6 uur — werkplek: Dorpsstraat 12, Amsterdam",
        quantity: 16,
        unitPrice: 45,
      },
      { description: "Materiaal: verf en tape", details: "", quantity: 1, unitPrice: 120 },
      { description: "Ladderhuur (2 dagen)", details: "", quantity: 2, unitPrice: 15 },
    ],
    vatMode: "standard",
    vatRate: 21,
    validUntil: "2026-09-30",
